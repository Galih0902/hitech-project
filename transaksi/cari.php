...
<h2> Keyword "<?php echo $_GET['q'];?>"<h2>
    ...
    if(isset($_GET['q']) && $_GET['q']){
    	...
    	if(mysql_num_rows($result) > 0){
  		?>
<td><a href='add_transaksi.php'> Add Data |</a></td>
...
?>
  <tr align='center'>
            ...
            <a href='faktur.php?kode_transaksi=<?php echo $data['kode_transaksi'];?>' title="Klik Disini Untuk Cetak" target='_blank'>Print</a>
      </td>
...
?>
     <?php 
    	...
    	mysql_select_db("dbhitech");
    	$q = $_GET['q'];
    $query=mysql_query("select Sum(total_biaya) as jumlah from tb_transaksi where kode_transaksi like '%$q%'or tanggal like '%$q%' or pelanggan like '%$q%' or motor like '%$q%' or pilihan_modif like '%$q%' or biaya like '%$q%' or keterangan like '%$q%' or lama_pengerjaan like '%$q%' or tambahan_biaya like '%$q%' or total_biaya like '%$q%'");
