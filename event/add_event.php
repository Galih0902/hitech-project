...
if(isset($_POST['simpan'])){
 ...
 $simpan="insert into event values('$id','$judul','$isi')";
 $query=mysql_query($simpan);
echo "<script type='text/javascript'>
      alert('Data Berhasil Disimpan...!!!');
      </script>";
      echo "<meta http-equiv='refresh' content='0; data_event.php'>";
}
else
{
echo "<script type='text/javascript'>
      ...
      echo "<meta http-equiv='refresh' content='0; add_event.php'>";
}
}

function autoNumber ($id, $table){
  $query = 'SELECT MAX(RIGHT(id, 5)) as max_id FROM event ORDER BY id ASC';
...
<h2>Id : <input type="text" name="id" size="40" maxlength="35" value="<?php echo autoNumber('id','event');?>" readonly />
<br><br>
